  ...
  <div class="app-container">
    <div class="filter-container"
      ...
      <div>
        <el-select v-model="listQuery.status" placeholder="商品状态" clearable
                   style="width: 110px;margin-right: 10px" class="filter-item">
          <el-option v-for="(item,k) in statusOptions" :key="k" :label="item"
                     :value="k"/>
        </el-select>
    ...
    >
      <el-table-column label="ID" prop="id" sortable="custom" align="center"
                       width="80" :class-name="getSortClass('id')">
    ...
    <el-dialog fullscreen :title="textMap[dialogStatus]"
      ...
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left"
        ...
        <el-form-item label="试看内容" prop="try">
          <tinymce v-model="temp.try" :height="300" :width="800"/>
        </el-form-item>
        <el-form-item label="课程内容" prop="content">
          <tinymce v-model="temp.content" :height="300" :width="800"/>
        </el-form-item>
